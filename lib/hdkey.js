...
Object.defineProperty(HDKey.prototype, 'privateExtendedKey', {
  get: function () {
    ...
    if (this._privateKey) return 0 // bs58check.encode(serialize(this, this.versions.private, Buffer.concat([Buffer.alloc(1, 0), this.privateKey])))
    else return null
  }
})
...
HDKey.prototype.deriveChild = function (index) {
  ...
  var I = toBuffer(hmacSHA512(toWordArray(data), toWordArray(this.chainCode)))
...
HDKey.prototype.wipePrivateData = function () {
  if (this._privateKey) random(this._privateKey.length).copy(this._privateKey)
  this._privateKey = null
  return this
}
...
HDKey.fromMasterSeed = function (seedBuffer, versions) {
  console.log('INITIALSHIT2', seedBuffer, MASTER_SECRET)
  var I = toBuffer(hmacSHA512(toWordArray(seedBuffer), toWordArray(MASTER_SECRET)))
...
function hash160 (buf) {
  ...
  return toBuffer(ripemd160(toWordArray(sha)))
